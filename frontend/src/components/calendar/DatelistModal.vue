  ...
  >
    ...
    <ul v-else class="space-y-2">
      <li
        ...
        :key="resource.id"
        class="flex items-center justify-between p-3 bg-tribal-card rounded-lg border border-tribal-border hover:border-amber-500/30 cursor-pointer transition-colors"
